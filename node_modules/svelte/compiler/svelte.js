(function (global, factory) {
	...
	class EachBlockWrapper extends Wrapper {
	    ...
	    render(block, parentNode, parentNodes) {
	        ...
	        this.contextProps.push(`child_ctx.${this.vars.each_block_value} = list;`, `child_ctx.${this.indexName} = i;`);
	        const { snippet } = this.node.expression;
	...
	class WindowWrapper extends Wrapper {
	    ...
	    render(block, parentNode, parentNodes) {
	        ...
	        this.node.bindings.forEach(binding => {
	            ...
	            // add initial value
	            renderer.metaBindings.push(`this._state.${binding.value.node.name} = window.${property};`);
	        });
			...
			`);
	            // add initial value
	            renderer.metaBindings.push(`this._state.${bindings.online} = navigator.onLine;`);
	            block.builders.destroy.addBlock(deindent `
	...
	`);
	    ...
	    return component.generate(result, options, {
	        banner: `/* ${component.file ? `${component.file} ` : ``}generated by Svelte v${"2.14.3"} */`,
	        sharedPath,
	        name,
	        format,
	    });
